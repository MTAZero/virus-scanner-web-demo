...
## 2. Ý tưởng lý thuyết: vì sao “byte → ảnh”?
...
## 3. Chuỗi xử lý trong code (encoding)
...
## 6. Cách huấn luyện (`train_cnn.py`)
...
### 6.1. Synthetic (nhanh, chỉ để kiểm tra code)
...
### 6.2. Ảnh PNG theo class (khuyến nghị với dataset đã tải)
...
### 6.3. File nhị phân thô theo class
...
## 7. Suy luận (inference) và API web
